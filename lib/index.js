...
module.exports = {
  ...
  getWindowsWorkstation() {
    if (this.getPlatform() === 'Linux' || this.getPlatform() === 'Macintosh') throw new Error('getWindowsWorkstation requires to be on Microsoft Windows');
  ...
  getMotherboard() {
    ...
    if (platform === 'Linux' || platform === 'Macintosh') throw new SyntaxError(`Must be running on Windows, currently running on ${platform}.`);
